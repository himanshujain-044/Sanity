...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      name: 'pintrest',
      type: 'string',
      title: 'Pintrest Meta id',
      description: 'Enter Pintrest Meta tag Id obtained from website. It is required to make the form work.'
    }),
    defineField({
      name: 'adsenseId',
      type: 'string',
      title: 'Google Adsense Id',
      description: 'Enter Adsense Id obtained from website. It is required to make the form work.'
    }),
    defineField({
      name: 'analyticId',
      type: 'string',
      title: 'Google Analytics Id',
      description: 'Enter Analytics Id obtained from website. It is required to make the form work.'
    }),
  ]
})
